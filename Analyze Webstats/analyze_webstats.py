...
# model-plotting function definition
...
# initial data
plot_models(x, y, None, os.path.join(CHART_DIR, "chart_1.png"))
...
plot_models(x, y, [f1], os.path.join(CHART_DIR, "chart_2.png"))
plot_models(x, y, [f1, f2], os.path.join(CHART_DIR, "chart_3.png"))
plot_models(
    x, y, [f1, f2, f3, f10, f100], os.path.join(CHART_DIR, "chart_4.png"))
...
plot_models(x, y, [fa, fb], os.path.join(CHART_DIR, "chart_5.png"))
...
plot_models(
    ...
    os.path.join(CHART_DIR, "chart_6.png"),
...
plot_models(
    ...
    os.path.join(CHART_DIR, "chart_7.png"),
    mx=sp.linspace(0 * 7 * 24, 6 * 7 * 24, 100),
    ymax=10000, xmin=0 * 7 * 24)
...
plot_models(
    ...
    os.path.join(CHART_DIR, "chart_8.png"),
    mx=sp.linspace(0 * 7 * 24, 6 * 7 * 24, 100),
    ymax=10000, xmin=0 * 7 * 24)
